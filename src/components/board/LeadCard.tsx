...
export default function LeadCard({
  ...
  const isOverdue =
    nextAppt && new Date(nextAppt.starts_at).getTime() < Date.now();
  // Blijf de kaart markeren zolang de afspraak vandaag is óf al geweest is
  // (overdue). Pas als de afspraak verwijderd wordt (nextAppt === null) valt de
  // kaart terug naar normaal.
  const flagAppt = isToday || isOverdue;
  ...
  return (
    <>
      ...
      <button
        ...
        } ${flagAppt ? "hf-shake ring-2 ring-amber-400" : ""} ${
          draggable ? "cursor-grab active:cursor-grabbing" : ""
      ...
      >
        ...
        {nextAppt && (
          ...
          >
            ...
            {isOverdue ? "Geweest " : isToday ? "Vandaag " : ""}
